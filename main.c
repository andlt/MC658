...
void verifyAndPrintSolution(const STPInstance *instance, const EdgeList *solution, double solutionCost)
{
   double cost;
   int i, n, m;
...
int main(int argc, char **argv)
{
   ...
   while (solution->edges != NULL)
   {
      EdgeListNode *tmp = solution->edges;
      solution->edges = solution->edges->next;
      free(tmp);
   }
